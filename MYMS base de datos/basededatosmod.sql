...
CREATE TABLE IF NOT EXISTS `MYMS`.`Productos` (
  ...
  `Detallado` VARCHAR(2000) NULL DEFAULT NULL,
  PRIMARY KEY (`Codigo`))
ENGINE = InnoDB;
...
(17, 'Cookies & Cream', 'Galletas Oreo trituradas y una base cremosa', 'imagenes/galletas/20.png', '15', '50', 'Disponible', 'Esta opción es perfecta para quienes buscan un capricho cremoso, indulgente y lleno de textura, ideal para darse un gusto delicioso a cualquier hora del día. Está elaborado con una base helada y ultrasuave combinada con trozos generosos de galletas Oreo trituradas, mezcladas a la perfección con leche vegetal de almendra o avena sin gluten, logrando un equilibrio perfecto entre lo cremoso y lo crujiente. Los Toques de Galleta: La bebida integra de manera natural el sabor icónico del cacao y la vainilla de las galletas, aportando una dulzura reconfortante sin causar pesadez estomacal. El Sello de la Casa: Siguiendo la firma inconfundible de toda tu línea, el vaso se corona con una porción de crema batida a base de coco muy ligera y etérea, decorada con trozos extra de galleta crujiente y una cereza natural fresca en la cima que aporta el toque de color definitivo. Es una bebida helada premium, saciante y libre de lácteos, diseñada para disfrutar del auténtico placer del cookies & cream cuidando al 100% tu bienestar y digestión.'),
(18, 'Matcha Mood', 'Leche fría, hielo y auténtico matcha.', 'imagenes/galletas/21.png', '15', '50', 'Disponible', 'Esta opción es perfecta para quienes buscan un impulso de energía sostenida, antioxidante y lleno de frescura, ideal para encontrar tu momento de calma y concentración durante la jornada. Está elaborado con una base de auténtico té matcha ceremonial de alta calidad disuelto sobre hielo, mezclado suavemente con leche vegetal (como almendra o avena sin gluten), logrando una textura fluida, ligera y profundamente reconfortante. Los Toques Herbales y Dulces: La bebida destaca por sus notas herbales equilibradas con una dulzura delicada y natural, respetando la esencia pura del matcha sin notas amargas agresivas ni causar pesadez estomacal. El Sello de la Casa: Siguiendo la firma inconfundible de toda tu línea, el vaso se corona con una porción de crema batida a base de coco muy ligera y etérea, decorada con un fino espolvoreado de matcha y una cereza natural fresca en la cima que aporta el toque de color definitivo. Es una bebida helada premium, nutritiva y revitalizante, diseñada para disfrutar de todos los beneficios del matcha cuidando al 100% tu bienestar y digestión.'),
(19, 'Choco Latte Ice', 'Chocolate, café y leche fría sobre hielo', 'imagenes/galletas/22.png', '15', '50', 'Disponible', 'Esta opción es perfecta para quienes buscan la combinación ideal entre la intensidad del café y el placer del chocolate, ideal para reactivar tu tarde con un toque dulce y estimulante. Está elaborado con una base de café espresso de alta calidad mezclado con rico cacao infusionado sobre hielo, combinado con leche vegetal de almendra o avena sin gluten, logrando una textura suave, sedosa y reconfortante. Los Toques de Cacao: La bebida fusiona el cuerpo del café con un chocolate artesanal libre de lácteos, logrando esa armonía perfecta entre el amargor del café y las notas intensas del cacao sin causar pesadez estomacal. El Sello de la Casa: Siguiendo la firma inconfundible de toda tu línea, el vaso se corona con una porción de crema batida a base de coco muy ligera y etérea, decorada con hilos extra de jarabe de chocolate y una cereza natural fresca en la cima que aporta el toque de color definitivo. Es un mochaccino helado premium, nutritivo, saciante y completamente libre de alérgenos comunes, diseñado para disfrutar del placer del chocolate con café cuidando al 100% tu bienestar y digestión.');
-- -----------------------------------------------------
-- Table `MYMS`.`Usuarios`
-- -----------------------------------------------------
