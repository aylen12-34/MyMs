...
CREATE TABLE IF NOT EXISTS `MYMS`.`Usuarios` (
  ...
  INDEX `fk_Usuarios_Productos1_idx` (`Productos_Codigo` ASC),
  CONSTRAINT `fk_Usuarios_Productos1`
...
CREATE TABLE IF NOT EXISTS `MYMS`.`Carrito` (
  ...
  PRIMARY KEY (`Productos_Codigo`, `Pedidos_idPedidos`),
  INDEX `fk_Productos_has_Pedidos_Pedidos1_idx` (`Pedidos_idPedidos` ASC) ,
  ...
  CONSTRAINT `fk_Productos_has_Pedidos_Pedidos1`
    ...
    REFERENCES `MYMS`.`Pedidos` (`idPedidos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
